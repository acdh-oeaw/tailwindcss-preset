		...
		({ addBase, addComponents, addUtilities, matchUtilities, theme }) => {
			addBase({
				":root": {
					...
					"--space-0": "0",
					"--space-px": "1px",
					"--space-0.5": "calc(0.125rem * var(--ui-scaling-factor))",
					"--space-1": "calc(0.25rem * var(--ui-scaling-factor))",
					"--space-1.5": "calc(0.375rem * var(--ui-scaling-factor))",
					"--space-2": "calc(0.5rem * var(--ui-scaling-factor))",
					"--space-2.5": "calc(0.625rem * var(--ui-scaling-factor))",
					"--space-3": "calc(0.75rem * var(--ui-scaling-factor))",
					"--space-3.5": "calc(0.875rem * var(--ui-scaling-factor))",
