	...
	({ addBase }) => {
		...
		addBase({
			...
			":root[data-color-scheme=dark]": {
				...
				"--color-overlay-background": "var(--color-neutral-50)",
				"--color-primary-foreground": "var(--color-neutral-900)",
				"--color-primary-background": "var(--color-neutral-950)",
	...
	},
	{
		theme: {
			...
			colors: {
				...
				overlay: {
					foreground: "hsl(var(--color-overlay-foreground))",
					background: "hsl(var(--color-overlay-background))",
				},
				primary: {
				...
				negative: {
					foreground: "hsl(var(--color-negative-foreground))",
					background: "hsl(var(--color-negative-background))",
				},
				positive: {
					foreground: "hsl(var(--color-positive-foreground))",
					background: "hsl(var(--color-positive-background))",
				},
